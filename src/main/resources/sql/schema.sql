...
DROP TABLE IF EXISTS ENTRY_IMPRESSION;
...
CREATE TABLE ENTRY (
  ...
  , PRIMARY KEY (ID)
  , CONSTRAINT FK_CATEGORY_ENTRY FOREIGN KEY (CATEGORY_ID) REFERENCES CATEGORY (CATEGORY_ID) ON DELETE SET NULL
);
...
CREATE TABLE `ENTRY_IMPRESSION` (
    ID       INT NOT NULL AUTO_INCREMENT
  , ENTRY_ID INT NOT NULL
  , QUANTITY INT NOT NULL DEFAULT 0
  , VERSION  INT NOT NULL DEFAULT 0
  , PRIMARY KEY (ID)
  , CONSTRAINT FK_IMPRESSION_ENTRY_1 FOREIGN KEY (ENTRY_ID) REFERENCES ENTRY (ID)
  ON DELETE CASCADE
);
