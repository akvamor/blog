CKEDITOR.lang['ua'] = {
    "editor": "Візуальний текстовий редактор",
    "editorPanel": "Візуальний редактор тексту",
    "common": {
        "editorHelp": "Натисніть ALT-0 для відкриття довідки",
        "browseServer": "Вибір на сервері",
        "url": "Лінк",
        "protocol": "Протокол",
        ...
        "langCode": "Код мови",
        "longDescr": "Довгий опис посилання",
        "cssClass": "Клас CSS",
        ...
        "resize": "Перетягніть для зміни розміру",
        "generalTab": "Основне",
        "advancedTab": "Додатково",
        "validateNumberFailed": "Це значення не є числом.",
        "confirmNewPage": "Незбережені зміни будуть втрачені! Ви дійсно бажаєте перейти на іншу сторінку?",
        "confirmCancel": "Деякі параметри були змінені. Ви впевнені, що бажаєте закрити без збереження?",
        "options": "Параметри",
        "target": "Мета",
        ...
        "invalidHeight": "Висота задається числом.",
        "invalidWidth": "Ширина задається числом.",
        "invalidCssLength": "Значення, вказане в полі \"%1\", повинно бути додатним цілим числом. Допускається зазначення одиниць заходи CSS (px, %, in, cm, mm, em, ex, pt или pc).",
        "invalidHtmlLength": "Значення, вказане в полі \"%1\", повинно бути додатним цілим числом. Допускається зазначення одиниць заходи HTML (px або %).",
        "invalidInlineStyle": "Значення, вказане для стилю елемента, має складатися з однієї або кількох пар даних у форматі \"параметри : \", разделённых точкой с запятой.",
        "cssLengthTooltip": "Введіть значення в пікселях або число з коректною одиницею заходи CSS (px, %, в, см, мм, em, ex, pt або pc).",
        "unavailable": "%1<span class=\"cke_accessibility\">, недоступне</span>"
    },
    //*** not translated ***//
    "about": {
